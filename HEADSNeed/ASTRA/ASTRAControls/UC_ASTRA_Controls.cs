...
{
    public partial class UC_ASTRA_Controls : UserControl
    {
        ...
        public UC_ASTRA_Controls(string input_file)
        {
            //Member m;
            //MemberIncidence mi;
            //MemberProperty mp;
        ...
        public UC_ASTRA_Controls(string drawing_file, bool IsDrawingFile)
        {
            //Member m;
            //MemberIncidence mi;
            //MemberProperty mp;
        ...
        private void frm_ASTRA_Inputs_Load()
        {
            //Base_Control_MouseEvent();
