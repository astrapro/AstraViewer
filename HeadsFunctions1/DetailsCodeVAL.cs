...
namespace HeadsFunctions1.Valignment
{
    class DetailsCodeVAL
    {
        ...
        short i, turn1,  elemno, eltype, flag, errCode;

	    double xlate_x, xlate_y, XMIN, YMIN, textsize, textrotn, rotn, xfa, xta, yta;
	    double R, SL, L, B1, B2, DEL, RC, RCI, rep_chn, xst, yst, xed, yed;
        double store_RC, curchn, stchn, endchn, brgi, T1, T2, IPX, IPY, last_stchn;
        double last_endchn, xt, yt, zt, last_IPX, last_IPY, xstor, ystor, ths, thc;
        double qb1, qb2;
